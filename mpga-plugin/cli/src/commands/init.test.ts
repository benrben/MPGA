...
describe('registerInit', () => {
  ...
  it('creates the full MPGA directory structure', async () => {
  ...
  it('creates INDEX.md with project name and template placeholders', async () => {
    const { registerInit } = await import('./init.js');
    const program = new Command();
    program.exitOverride();
    registerInit(program);
  ...
  it('creates GRAPH.md with Mermaid placeholder', async () => {
    const { registerInit } = await import('./init.js');
    const program = new Command();
    program.exitOverride();
    registerInit(program);
  ...
  it('creates mpga.config.json with default configuration', async () => {
    const { registerInit } = await import('./init.js');
    const program = new Command();
    program.exitOverride();
    registerInit(program);
  ...
  it('creates board.json with empty columns and zero stats', async () => {
    const { registerInit } = await import('./init.js');
    const program = new Command();
    program.exitOverride();
    registerInit(program);
  ...
  it('creates BOARD.md with initial placeholder', async () => {
    const { registerInit } = await import('./init.js');
    const program = new Command();
    program.exitOverride();
    registerInit(program);
  ...
  it('--from-existing detects project type and sets languages', async () => {
    const { registerInit } = await import('./init.js');
    const program = new Command();
    program.exitOverride();
    registerInit(program);
...
describe('registerConfig', () => {
  ...
  it('config show --json outputs valid JSON with project config', async () => {
  ...
  it('config show without --json outputs formatted key-value lines', async () => {
    const { registerConfig } = await import('./config.js');
    const program = new Command();
    program.exitOverride();
    registerConfig(program);
  ...
  it('config set updates a numeric config value', async () => {
    const { registerConfig } = await import('./config.js');
    const program = new Command();
    program.exitOverride();
    registerConfig(program);
  ...
  it('config set exits with error for unknown key', async () => {
    const { registerConfig } = await import('./config.js');
    const program = new Command();
    program.exitOverride();
    registerConfig(program);
...
describe('registerStatus', () => {
  ...
  it('--json returns correct structure with initialized project', async () => {
  ...
  it('--json returns lastSync as "never" when INDEX.md has placeholder', async () => {
    seedMpgaProject(tmpDir, {
      indexContent:
  ...
  it('--json returns zero scopes when none exist', async () => {
    seedMpgaProject(tmpDir);
  ...
  it('non-JSON mode calls logger functions for formatted output', async () => {
...
describe('registerHealth', () => {
  ...
  it('--json returns correct health report structure', async () => {
  ...
  it('--json includes correct grade for 100% health', async () => {
    seedMpgaProject(tmpDir);
  ...
  it('--json reports lastSync as "never" when INDEX.md has placeholder', async () => {
    seedMpgaProject(tmpDir, {
  ...
  it('non-JSON mode calls miniBanner and logger header', async () => {
    seedMpgaProject(tmpDir);
