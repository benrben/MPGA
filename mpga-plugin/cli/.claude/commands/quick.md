...
3. Create a mini-plan (1-3 tasks) on the board:
   `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh board add "<sub-task>" --priority medium`
4. Execute TDD cycle (green → red → blue → review)
5. Run `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh evidence verify` after completion
