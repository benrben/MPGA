...
2. Run `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh evidence verify` — flag any new stale links
...
5. Update milestone status: `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh milestone status`
6. Archive done tasks: `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh board archive`
