...
1. Check context budget: `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh session budget`
...
3. Save handoff document: `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh session handoff --accomplished "<summary>"`
4. Log the session: `/Users/benreich/MPGA/mpga-plugin/bin/mpga.sh session log "<brief description of work done>"`
