...
| Claim | Evidence |
|-------|----------|
| `Dependency` (interface) | [E] src/generators/graph-md.ts :: Dependency |
| `GraphData` (interface) | [E] src/generators/graph-md.ts :: GraphData |
| `buildGraph` (function) | [E] src/generators/graph-md.ts :: buildGraph |
| `renderGraphMd` (function) | [E] src/generators/graph-md.ts :: renderGraphMd |
| `renderIndexMd` (function) | [E] src/generators/index-md.ts :: renderIndexMd |
| `ScopeInfo` (interface) | [E] src/generators/scope-md.ts :: ScopeInfo |
| `getScopeName` (function) | [E] src/generators/scope-md.ts :: getScopeName |
| `groupIntoScopes` (function) | [E] src/generators/scope-md.ts :: groupIntoScopes |
| `renderScopeMd` (function) | [E] src/generators/scope-md.ts :: renderScopeMd |

## Files

- `src/generators/graph-md.ts` (177 lines, typescript)
- `src/generators/index-md.ts` (77 lines, typescript)
- `src/generators/scope-md.ts` (356 lines, typescript)
