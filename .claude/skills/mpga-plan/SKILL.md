...
node ./.mpga-runtime/cli/dist/index.js milestone list
...
```
node ./.mpga-runtime/cli/dist/index.js board live --serve --open
node ./.mpga-runtime/cli/dist/index.js milestone new "<goal name>"
```
...
For each task, run:
```
node ./.mpga-runtime/cli/dist/index.js board add "<title>" \
  --priority <level> \
  --scope <scope> \
  --column todo \
