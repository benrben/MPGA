...
flowchart TD
    ...
    R --> S[Rank suggestions by Impact/Effort ratio — the ART of the DEAL]
    S --> T{HIGH impact + LOW effort?}
    T -->|Yes| U[Mark as DO NOW — no EXCUSES]
    T -->|No| V{HIGH impact + MEDIUM effort?}
    V -->|Yes| W[Mark as PLAN IT — STRATEGIC]
    V -->|No| X[Mark as QUICK WIN or SKIP — pick your BATTLES]
