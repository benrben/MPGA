...
- Scope documents (filled by our FANTASTIC scout agents) — view with `mpga scope list`
...
- ADRs for any proposed architectural changes (stored in the DB (`.mpga/mpga.db`)) — TREMENDOUS decisions
