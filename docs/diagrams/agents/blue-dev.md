...
flowchart TD
    ...
    I -->|No| J[Immediately revert — we don't ship GARBAGE]
    J --> E
    ...
    R --> S[mpga spoke announcement — HUGE improvement]
```
...
- Metrics snapshot: before and after values — PROOF of improvement, folks
